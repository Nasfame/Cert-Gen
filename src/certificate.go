...
// MoveAbs : Move without drawing path
...
func main() {
	...
	primary := color.RGBA{15, 157, 88, 255}
	secondary := color.RGBA{244, 160, 0, 220}
	...
	fpdf.SetTextColor(50, 50, 50)
	fpdf.Text(316, 554, "This is not a official certificate :)")
	...
	fmt.Println("Certificate was successfully generated!")
}
